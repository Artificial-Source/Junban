...
- [`../goals/rust-rewrite/evidence/phase-7-process-memory-calibration-plan.md`](../goals/rust-rewrite/evidence/phase-7-process-memory-calibration-plan.md): calibration-only cross-platform child process-memory preflight, linked single-machine Linux raw JSON, and pending cap protocol
