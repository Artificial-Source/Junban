    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        ...
        <button
          ...
          className={`${isView ? "px-5 py-2.5" : "px-4 py-2"} text-sm bg-accent-action text-on-accent-action rounded-lg hover:bg-accent-action-hover transition-colors flex items-center gap-2`}
        >
