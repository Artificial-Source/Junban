...
**Status:** approved by the user on 2026-07-28 and expanded with an evidence-driven Phase 10 on 2026-07-29. Phases 0 through 6 are complete. Phase 7 capability-limited portable plugins are in progress: Waves 1 and child-runtime Slice 2B are accepted; Slice 2C, Slice 2D, Wave 2, supervisor, resync, and final callback composition are not accepted. At exact clean HEAD `dbf63a58f38df245b0b62337b29c644b8054984c`, focused query planning recheck **APPROVED** and closes `P7-PLAN-2D-005`/`P7-PLAN-2D-005-UUID`, authorizing app/storage coding only while preserving exact UUID octet/nil/non-RFC/version semantics, fixed 122-byte layout, MAC, and error mapping. Final supervisor security recheck **APPROVED** exact `768671ed07cc55df902d525d757d8fb0f1eb0308`, closing `P7-2C-SEC-004`/`P7-2C-TEST-001` for final supervisor/Slice 2C coding security only. Bounded resync integrated at `1cc4ba9` (reviewed implementation equivalent `90467bf`) received focused database **APPROVE** with no material issues: 62 app tests, 280 storage tests, focused resync tests, Clippy warnings denied, and format/diff; it has no schema/WIT/public/dependency expansion, no global event/revision/receipt, and one final transaction, and server composition may consume its APIs. EOF fixture correction `71856e5` consumes exact parent Hello before deliberate EOF; focused debug/release passed, resolving the second prior Rust race, but no exact-head CI rerun exists and CI green is not claimed. `P7-2D-DB-002`, ordinary query implementation, callback/server composition, integrated CI/evidence, Slice 2C/Slice 2D/Wave 2/Phase acceptance, `P7-DEP-001`, later packets, and Phases 8–10 remain open.
...
- [ ] Phase 7 portable-plugin implementation (Waves 1–5). Wave 0/1 gates are approved. Exact `dbf63a58f38df245b0b62337b29c644b8054984c` query planning recheck closed `P7-PLAN-2D-005`/`P7-PLAN-2D-005-UUID`, authorizing app/storage coding only. Exact `768671ed07cc55df902d525d757d8fb0f1eb0308` final supervisor security recheck closed `P7-2C-SEC-004`/`P7-2C-TEST-001` for coding security only. Bounded resync at `1cc4ba9` (reviewed equivalent `90467bf`) is focused database-approved for server consumption, not overall resync acceptance. `P7-2D-DB-002`, ordinary query implementation, callback/server composition, integrated CI/evidence, supervisor/Slice 2C/Slice 2D/Wave 2/Phase acceptance, `P7-DEP-001`, and later packets remain open; no exact-head CI rerun after EOF correction `71856e5` means CI green is not claimed.
  ...
  - [x] `P7-PLAN-2D-005`/`P7-PLAN-2D-005-UUID` focused planning recheck **APPROVED** at exact `dbf63a58f38df245b0b62337b29c644b8054984c`, closing both and authorizing app/storage coding only. Exact UUID octet/nil/non-RFC/version semantics, fixed 122-byte layout, MAC, and error mapping remain preserved; implementation and callback composition remain unaccepted.
...
- `P7-PLAN-2D-005` — **high/fixed and closed** by focused planning recheck **APPROVED** at exact `dbf63a58f38df245b0b62337b29c644b8054984c`; it authorizes app/storage coding only and does not accept implementation or callback composition.
...
- 2026-08-09: Focused query planning recheck **APPROVED** exact `dbf63a58f38df245b0b62337b29c644b8054984c`, closing `P7-PLAN-2D-005`/`P7-PLAN-2D-005-UUID` and authorizing app/storage coding only. It preserves exact UUID octet/nil/non-RFC/version semantics, fixed 122-byte layout, MAC, and error mapping; implementation and callback composition remain unaccepted.
