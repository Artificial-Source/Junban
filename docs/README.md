...
- [`../goals/rust-rewrite/evidence/phase-6-wave-4.md`](../goals/rust-rewrite/evidence/phase-6-wave-4.md): active preserved React AI/voice, browser/local speech, visual, and accessibility implementation boundary
