declare module "junban:plugin/types@0.1.0" {
  ...
  export type ScalarValue =
    | ScalarValueStringValue
    | ScalarValueIntegerValue
    | ScalarValueBooleanValue
    | ScalarValueDateValue
    | ScalarValueTimestampValue
    | ScalarValueTaskId
    | ScalarValueProjectId
    | ScalarValueTagId
    | ScalarValuePluginId
    | ScalarValueOptionId;
  ...
  export type DataValue =
    | DataValueScalar
    | DataValueStringList
    | DataValueIntegerList
    | DataValueBooleanList
    | DataValueDateList
    | DataValueTimestampList
    | DataValueTaskIdList
    | DataValueProjectIdList
    | DataValueTagIdList
    | DataValuePluginIdList
    | DataValueOptionIdList;
  ...
  export type OptionalStringChange =
    OptionalStringChangeUnchanged | OptionalStringChangeClear | OptionalStringChangeSet;
  ...
  export type OptionalIdChange =
    OptionalIdChangeUnchanged | OptionalIdChangeClear | OptionalIdChangeSet;
  ...
  export type OptionalDateChange =
    OptionalDateChangeUnchanged | OptionalDateChangeClear | OptionalDateChangeSet;
  ...
  export type OptionalTimestampChange =
    OptionalTimestampChangeUnchanged | OptionalTimestampChangeClear | OptionalTimestampChangeSet;
  ...
  export type OptionalLocalDueTimeChange =
    | OptionalLocalDueTimeChangeUnchanged
    | OptionalLocalDueTimeChangeClear
    | OptionalLocalDueTimeChangeSet;
  ...
  export type OptionalU32Change =
    OptionalU32ChangeUnchanged | OptionalU32ChangeClear | OptionalU32ChangeSet;
  ...
  export type OptionalU8Change =
    OptionalU8ChangeUnchanged | OptionalU8ChangeClear | OptionalU8ChangeSet;
  ...
  export type OptionalPriorityChange =
    OptionalPriorityChangeUnchanged | OptionalPriorityChangeClear | OptionalPriorityChangeSet;
  ...
  export type DomainMutation =
    | DomainMutationCreateTask
    | DomainMutationPatchTask
    | DomainMutationCompleteTask
    | DomainMutationUncompleteTask
    | DomainMutationCancelTask
    | DomainMutationReopenTask
    | DomainMutationDeleteTask
    | DomainMutationBulkTasks
    | DomainMutationCreateProject
    | DomainMutationPatchProject
    | DomainMutationDeleteProject
    | DomainMutationCreateTag
    | DomainMutationPatchTag
    | DomainMutationDeleteTag;
  ...
  export type EventSubject =
    ...
    | EventSubjectTag
    | EventSubjectSection
    | EventSubjectDeletedTask
    | EventSubjectDeletedProject
    | EventSubjectDeletedTag
    | EventSubjectDeletedSection;
  ...
  export type SettingValue =
    SettingValueText | SettingValueInteger | SettingValueBoolean | SettingValueOptionId;
  ...
  export type SnapshotRecords =
    SnapshotRecordsTasks | SnapshotRecordsProjects | SnapshotRecordsTags;
  ...
  export type ResyncPageOutcome =
    ResyncPageOutcomeSnapshotAck | ResyncPageOutcomeFlushAck | ResyncPageOutcomeFinalized;
