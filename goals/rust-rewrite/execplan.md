...
- 2026-08-04: Phase 6 disabled acceptance uses the same-host Phase 5 parent/Phase 6 head matched protocol, while enabled acceptance is separate local-mock evidence. The accepted run passed at 8.2852 MiB disabled median warm and 10.4609/12.4570 MiB enabled maximum post-session warm/cgroup peak without a waiver.
...
- **Performance:** five matched disabled pairs passed at 8.2852 MiB median / 9.2852 MiB maximum warm and peak, only 0.1563 MiB above the 8.1289 MiB Phase 5 parent median. Three enabled local-mock profiles passed at 10.4609 MiB maximum post-session warm and 12.4570 MiB maximum cgroup peak; first-event, completed-turn, cancellation, STT/TTS, cleanup, growth, secrecy, and process gates all passed.
