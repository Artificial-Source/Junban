...
- 2026-08-09: Shared symmetric SDK framing codec extraction commit `aa3e591` is integrated and locally validated as a Packet C foundation and remains outside Packet A's exact review scope. The later process-transport review found no material codec issue, but no remote current-head gate is claimed.
